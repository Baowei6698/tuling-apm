...
import com.tuling.apm.model.JdbcStatistics;
...
public class JdbcCommonCollects extends AbstractByteTransformCollect implements ICollect {
    ...
    static {
        // connect
        beginSrc = "com.tuling.apm.collects.JdbcCommonCollects inst=com.tuling.apm.collects.JdbcCommonCollects.INSTANCE;";
